...
public class TeluskoDAtaJPAFifthStaticProjection {

	public static void main(String[] args) {
		ConfigurableApplicationContext container = SpringApplication.run(TeluskoDAtaJPAFifthStaticProjection.class, args);
